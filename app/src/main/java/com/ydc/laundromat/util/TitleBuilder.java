...
public class TitleBuilder {
	...
	public TitleBuilder(Activity context) {
		...
		etTitle = (EditText) viewTitle.findViewById(R.id.titlebar_et);
	...
	public TitleBuilder setEditText(boolean enableEditText) {
		etTitle.setVisibility(enableEditText == false ? View.GONE
				: View.VISIBLE);
